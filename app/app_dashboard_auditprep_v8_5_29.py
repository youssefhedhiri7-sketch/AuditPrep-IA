# ============================================================
# AuditPrep IA - V8.5.29 — version finale épurée + contraste complet Light/Dark
# Base : V8.4 sécurisée + interface portail métier Convergence
# Fichier à placer dans : C:\PFE Omar\AuditPrep-IA\app\app_dashboard_auditprep_v8_5_29.py
#
# Lancement PowerShell :
#   cd "C:\PFE Omar\AuditPrep-IA"
#   conda run -n auditprep python -m streamlit run "app\app_dashboard_auditprep_v8_5_29.py"
# ============================================================
